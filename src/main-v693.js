...
const activePointers`;
if(!inputPattern.test(src)) throw new Error('v6.9.3: input block not found');
...
function renderSplitArena`;
if(!cameraPattern.test(src)) throw new Error('v6.9.3: chase camera block not found');
...
function setCameraMode`;
if(!splitPattern.test(src)) throw new Error('v6.9.3: split render block not found');
